...
Module.register("MMM-DutchWeatherStatic",{
	// Default module config.
	defaults: {
		updateInterval: 10 * 60 * 1000,
		weatherProvider: "weerlivenl",
		roundTemp: false,
		...
		updateInterval: 20 * 60 * 1000, // every 10 minutes
		animationSpeed: 1000,
	...
	getStyles: function() {
		return ["font-awesome.css", "weather-icons.css", "MMM-DutchWeatherStatic.css"];
	},
